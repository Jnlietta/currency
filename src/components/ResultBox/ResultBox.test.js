...
describe('Component ResultBox', () => {
    ...
    describe('should render proper info about conversion when PLN -> USD', () => {
        ...
        for(const testObj of testCases) {
            ...
            it('test', () => {
                // render component
                render(<ResultBox key={testObj.amount} from="PLN" to="USD" amount={amountAsNum} />);
    ...
    describe('should render proper info about conversion when USD -> PLN', () => {
        ...
        for(const testObj of testCases) {
            ...
            it('test', () => {
                // render component
                render(<ResultBox key={testObj.amount} from="USD" to="PLN" amount={amountAsNum} />);
    ...
    describe('should render proper info about conversion when from=to', () => {
        ...
        for(const testObj of testCases) {
            ...
            it('test', () => {
                //render component
                render(<ResultBox key={testObj.from} from={testObj.from} to={testObj.to} amount={testObj.amount} />);
